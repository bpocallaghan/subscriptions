...
namespace Bpocallaghan\Subscriptions\Commands;
...
class PublishCommand extends Command
{
     ...
     * @var string
     */
    protected $name = 'subscriptions:publish';
    ...
    private function copyModels()
    {
        ...
        // copy files
        $search = "namespace Bpocallaghan\Subscriptions\Models;";
    ...
    private function copyViews()
    {
        ...
        $destination = resource_path('views\admin\subscriptions');
        $this->copyFilesFromSource($source, $destination);

        // ADMIN
        $source = $this->basePath . "resources\\views\admin\\features";
        $destination = resource_path('views\admin\subscriptions\features');
        $this->copyFilesFromSource($source, $destination);

        // WEBSITE
        $source = $this->basePath . "resources\\views\website";
        $destination = resource_path('views\website\subscriptions');
        $this->copyFilesFromSource($source, $destination);
    }
    ...
    private function copyControllers()
    {
        ...
        $destination = app_path('Http\Controllers\Admin\Settings\Subscriptions');

        // copy files
        $search = ["subscriptions::", "Bpocallaghan\Subscriptions\Models", "namespace Bpocallaghan\Subscriptions\Controllers\Admin;"];
        $replace = ["subscriptions.", "App\Models", "namespace App\Http\Controllers\Admin\Settings\Subscriptions;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
        ...
        // replace files
        $search = ["subscriptions::", "Bpocallaghan\Subscriptions\Models", "namespace Bpocallaghan\Subscriptions\Controllers\Website;"];
        $replace = ["subscriptions.", "App\Models", "namespace App\Http\Controllers\Website;"];
        $this->copyFilesFromSource($source, $destination, $search, $replace);
    }
    ...
    private function copyDatabase()
    {
        ...
        $search = "namespace Bpocallaghan\Subscriptions\Seeds;";
        $this->copyFilesFromSource($source, $destination, $search);

        // CSV
        $source = $this->basePath . "database\seeds\csv";
        $destination = database_path('seeds\csv');
        $this->copyFilesFromSource($source, $destination);
        ...
        $search = "namespace Bpocallaghan\Subscriptions\Migrations;";
        $this->copyFilesFromSource($source, $destination, $search);
    }
