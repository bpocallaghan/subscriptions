...
namespace Bpocallaghan\Subscriptions\Controllers\Admin;
...
class SubscriptionPlansController extends AdminController
{
    ...
    public function create()
    {
        ...
        return $this->view('subscriptions::create_edit')
    ...
    {
        return $this->view('subscriptions::show')
    ...
    public function showFeaturesOrder(SubscriptionPlan $subscription_plan)
    {
        ...
        return $this->view('subscriptions::features_order')
            ->with('itemsHtml', $html);
    }
